...
enum MoleculeVisualizationStyle: CaseIterable {
    case spacefilling
    case ballAndStick
    case electronCloud
    ...
    var displayName: String {
        ...
        case .electronCloud: return "Electron Cloud"
        }
    }

    func next() -> MoleculeVisualizationStyle {
        let all = MoleculeVisualizationStyle.allCases
