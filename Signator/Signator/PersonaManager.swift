...
class PersonaManager: ObservableObject {
    ...
    @Published var activePersonaId: String? = nil {
        didSet {
    ...
    @Published var dismissCreationFlow: Bool = false
    ...
    func updatePersonaStatus(personaId: String, status: String) {
    ...
    func recoverPersonaByDID(_ did: String) async throws {
