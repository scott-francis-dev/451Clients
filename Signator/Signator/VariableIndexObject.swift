...
//
//  ⚠️ MIRRORED FILE. Canonical copy lives in Core451 at
//  451Core/Sources/Core451/Models/VariableIndexObject.swift. Signator is decoupled from Core451
//  and keeps this copy, exactly as it mirrors Document451. Keep the two textually in sync.
//
