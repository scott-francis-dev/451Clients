...
public final class CollaboratorsStore: ObservableObject {
    public static let shared = CollaboratorsStore()

    @Published public private(set) var collaborators: [PersonaResolvedProfile] = []
    ...
    public func add(_ profile: PersonaResolvedProfile) {
