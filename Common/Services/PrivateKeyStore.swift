...
public struct PrivateKeyStore {
    ...
    public static func savePrivateKey(_ privateKey: P256.Signing.PrivateKey, for personaId: String) throws {
    ...
    public static func loadPrivateKey(for personaId: String) throws -> P256.Signing.PrivateKey {
