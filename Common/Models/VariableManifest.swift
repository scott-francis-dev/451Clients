...
//
//  Single shared copy. Signator and thesis both compile Common/, so this file serves
//  both targets and there is nothing to keep in sync. It previously existed twice —
//  here and under Signator/ — with headers instructing whoever edited one to remember
//  the other, which is the arrangement the Common/ migration exists to end.
//
