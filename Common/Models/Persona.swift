...
public struct Persona: Identifiable, Codable, Equatable {
    // 🆔 Core
    ...
    public var id: String   // Full DID
    public var controller: String

    // 🧑‍💼 Persona Info
    public var name: String
    public var handle: String             // ATProtocol: human-readable identifier (e.g., sara.silver.silver.publishing.451.info)
    public var displayName: String?       // Human-readable name part (e.g., "Sam Sooner")
    public var displayPublisher: String?  // Human-readable publisher part (e.g., "Sooner Publishing")
    public var address: String?
    public var email: String?
    public var emailVerified: Bool = false
    public var orcid: String?             // Optional: ORCID identifier (format: 0000-0002-1825-0097)
    public var orcidVerified: Bool = false
    public var affiliations: String?
    public var socialLinks: String?
    public var status: String = "active" // Possible values: "active", "archived", etc.
    ...
    // 📂 Nested Types
    public struct StorageEndpoint: Codable, Identifiable, Equatable {
        ...
        public init(did: String, providerName: String, url: String, eTag: String? = nil) {
            self.did = did
...
extension Persona {
    ...
    public var shortIDPhoneStyle: String {
        let s = shortID
    ...
    public var isOrcidFormatValid: Bool {
    ...
    public var formattedOrcid: String? {
    ...
    public var effectiveDisplayPublisher: String? {
    ...
    public var credentialBadges: [String] {
        var badges: [String] = []
    ...
    public var credentialDisplay: String {
...
extension String {
    ...
    public static func validateAndFormatOrcid(_ input: String) -> String? {
    ...
    public static func formatOrcidInput(_ input: String) -> String {
